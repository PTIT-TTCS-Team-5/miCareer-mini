...
## 4. Chi tiết các Bước trong RAG Pipeline

### Bước 4.1: Mã hóa Yêu cầu (Prompt Embedding)
...
### Bước 4.2: K-Nearest Neighbors Retrieval
...
### Bước 4.3: Multi-Tier Generation (Tự động Sinh Câu Trả Lời)
